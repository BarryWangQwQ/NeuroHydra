      ...
      items: [
        {
          ...
          title: 'Dense Imaging',
          highlight: '(High-Dim)',
          descriptionLine1: '结构性 MRI（T1w + FLAIR），约 10^7 体素/体积。',
          descriptionLine2: '需要稳健特征提取（DINOv3）。'
        },
        {
          icon: FileText,
          title: 'Sparse Clinical',
          highlight: '(Low-Dim)',
          descriptionLine1: '约 20 个变量：年龄、起病、症状学、ASM。',
      ...
      items: [
        {
          ...
          title: 'Dense Imaging',
          highlight: '(High-Dim)',
          descriptionLine1: 'Structural MRI (T1w + FLAIR). ~10^7 voxels per volume.',
          descriptionLine2: 'Requires robust feature extraction (DINOv3).'
        },
        {
          icon: FileText,
          title: 'Sparse Clinical',
          highlight: '(Low-Dim)',
          descriptionLine1: '~20 variables: Age, Onset, Semiology, ASM.',
